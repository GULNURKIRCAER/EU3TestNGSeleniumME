...
public class verifyContactInfoTest extends TestBase {
    ...
    public void contactDetailsTest(){
        ...
        LoginPage loginPage = new LoginPage();//rapor etmiyoruz
        ...
        ContactsPage contactsPage = new ContactsPage();//rapor etmiyoruz

        extentLogger.info("Click on mbrackstone9@example.com");

        contactsPage.waitUntilLoaderScreenDisappear();//rapor etmiyoruz
