...
public class ExcelUtilsDemo {
    ...
    public void readExcelFile(){
        ...
        ExcelUtil qa3short = new ExcelUtil("src/test/resources/Vytracktestdata.xlsx","QA3-short");
                                        //excel file'in uzerine gidip sag tus+copy+copypath diyoruz.    //excel file da ki hangi worksheetse onun adini yaziyoruz
        ...
        List<Map<String, String>> dataList = qa3short.getDataList();//option +enter+enter
        for (Map<String, String> onerow : dataList) {
            System.out.println(onerow);
        }
       // System.out.println("dataList.get(2) = " + dataList.get(0)); columns adlarini almiyoruz. 1.row=0
        //get Nona as a value
